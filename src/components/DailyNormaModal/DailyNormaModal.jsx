  ...
  return (
    <Modal modalTitle="My daily norma" onClose={onClose} setIsOpen={setIsOpen} isOpen={isOpen}>
      ...
      <p className={css.instruction_text}>
        ...
        liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)
      </p>
      <form>
        ...
        <div>
          <p className={css.small_text}>Write down how much water you will drink:{" "}</p>
          <input
            className={css.input}
            type="text"
            value={consumedWater}
